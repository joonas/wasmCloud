...
import (
	...
	"github.com/wasmcloud/wasmcloud/examples/golang/components/http-client-tinygo/wasitel/types/resource"
)
...
type ScopeSpans struct {
	...
	Scope *common.InstrumentationScope `json:"scope,omitempty"`
